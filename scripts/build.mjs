...
function structuredData(path,page){
  ...
  if(path&&path!=='404')graph.push({'@type':'BreadcrumbList','@id':url+'#breadcrumb',itemListElement:[
    ...
    {'@type':'ListItem',position:2,name:page.title.replace(' · EDIT Saffron',''),item:url}
  ]});
