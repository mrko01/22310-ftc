...
for(const [path,page]of Object.entries(pages)){
  ...
  const schema=JSON.stringify({'@context':'https://schema.org','@type':page.type,'name':page.title,'description':page.description,'url':url,'about':{'@type':'Organization','name':'EDIT Saffron','alternateName':'FTC Team 22310','url':'https://22310.ca/','logo':'https://22310.ca/assets/saffron-logo-matched-stigmas.png?v=5'}});
  cspHashes.push("'sha256-"+createHash('sha256').update(schema).digest('base64')+"'");
  const html=`<!doctype html>\n<html lang="en-CA"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover"><meta name="theme-color" content="#fffdfb"><title>${page.title}</title><meta name="description" content="${page.description}"><link rel="canonical" href="${url}"><meta property="og:title" content="${page.title}"><meta property="og:description" content="${page.description}"><meta property="og:type" content="website"><meta property="og:url" content="${url}"><meta property="og:site_name" content="EDIT Saffron"><meta property="og:image" content="https://22310.ca/assets/saffron-logo-matched-stigmas.png?v=5"><meta property="og:image:alt" content="Minimalist saffron flowers with coordinated filaments and Team 22310 warm orange wordmark"><meta name="twitter:card" content="summary"><meta name="robots" content="${path==='404'?'noindex':'index, follow, max-image-preview:large'}"><link rel="icon" href="/assets/saffron-app-32.png?v=5" type="image/png"><link rel="apple-touch-icon" href="/assets/saffron-app-180.png?v=5"><link rel="preload" href="/assets/dm-sans-400.woff2" as="font" type="font/woff2" crossorigin><link rel="stylesheet" href="/assets/site.css?v=${cssHash}"><script type="module" src="/assets/site.js?v=${jsHash}"></script><script type="application/ld+json">${schema}</script></head><body>${navigation(path)}${page.body}${footer}</body></html>\n`;
